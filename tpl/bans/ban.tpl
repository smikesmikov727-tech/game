<div class="col-lg-6">
	...
	<div class="block ban-application ban-information">
		...
		<button onclick="close_ban_from_apps({id},'1','{bid}');" type="button" class="btn btn-success">Разбанен</button>
		<button onclick="close_ban_from_apps({id},'2','{bid}');" type="button" class="btn btn-warning">Не разбанен</button>
		{/if}
