...
// Показывать страницу входа для неавторизованных пользователей
// -----------------
// 0 - нет (стандартное поведение)
// 1 - да (показывать страницу входа)
{var:show_auth_page} 1 {/var}
...
{var:slider[0]['image']} ../templates/standart/img/slide-1.jpg?v={cache} {/var}
...
{var:slider[1]['image']} ../templates/standart/img/slide-2.jpg?v={cache} {/var}
...
{var:slider[2]['image']} ../templates/standart/img/slide-3.jpg?v={cache} {/var}
...
{var:footer_banners[0]['img']} ../templates/standart/img/placeholder-88x31.svg?v={cache} {/var}
//banner 2
{var:footer_banners[1]['link']} https://gamecms.ru/ {/var}
{var:footer_banners[1]['img']} ../templates/standart/img/placeholder-88x31.svg?v={cache} {/var}
//banner 3
{var:footer_banners[2]['link']} https://gamecms.ru/ {/var}
{var:footer_banners[2]['img']} ../templates/standart/img/placeholder-88x31.svg?v={cache} {/var}
