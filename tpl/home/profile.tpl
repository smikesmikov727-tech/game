	...
	<div class="row profile-page">
		<div class="col-lg-4">
			<div class="block profile">
				<img src="../{avatar}?v={cache}" alt="{login}">
			...
			<div class="block profile">
				...
				<table class="table mb-0">
                    ...
                    {if('{dell}' != '1')}
                        ...
                        {if('{skype}' != '' || '{telegram}' != '' || '{discord}' != '' || '{vk}' != '' || '{steam_api}' != '0' || '{fb}' != '0')}
							<tr>
								<td colspan="2">
                            ...
                            {if('{vk}' != '')}
								<tr>
									<td>Вконтакте</td>
									<td>
										<a title="Перейти в профиль Вконтакте" target="_blank" href="https://vk.ru/{vk}" id="vk_user">
